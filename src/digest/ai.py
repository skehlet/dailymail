...
class NewsletterContent(BaseModel):
    """
    Defines the expected structure for the entire newsletter content generated by the AI.
...
Return your result in JSON format: {NewsletterContent.model_json_schema()}
"""
    ...
    try:
        ...
        print(f"--- Error during AI call or processing ---")
        print(f"Error details: {e}")
        raise e
