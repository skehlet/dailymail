...
feed_metadata_table = dynamodb.Table("dailymail-rss-reader-feed_metadata-table")
processed_ids_table = dynamodb.Table("dailymail-rss-reader-processed-ids-table")
